...
replace (
	...
	github.com/AthenZ/athenz-authorizer/v5 => github.com/AthenZ/athenz-authorizer/v5 v5.8.5-0.20260917024127-31c36c01e6a8
	...
	github.com/prometheus/client_model => github.com/prometheus/client_model v0.6.3
	golang.org/x/sync => golang.org/x/sync v0.23.0
	google.golang.org/genproto/googleapis/rpc => google.golang.org/genproto/googleapis/rpc v0.0.0-20260911204522-f61a6ca850bd
...
require (
	github.com/AthenZ/athenz v1.12.48 // indirect
	...
	github.com/theparanoids/crypki v1.21.3 // indirect
