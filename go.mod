...
replace (
	...
	github.com/AthenZ/athenz-authorizer/v5 => github.com/AthenZ/athenz-authorizer/v5 v5.8.3-0.20260618081521-60b27907d38b
	...
	golang.org/x/sync => golang.org/x/sync v0.21.0
