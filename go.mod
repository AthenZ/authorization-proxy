...
replace (
	...
	github.com/AthenZ/athenz-authorizer/v5 => github.com/AthenZ/athenz-authorizer/v5 v5.8.4-0.20260724024203-2c5c8092c470
...
require (
	github.com/AthenZ/athenz v1.12.44 // indirect
